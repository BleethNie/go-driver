...
import (
	...
	"github.com/BleethNie/go-driver/iecp/clog"
)
...
func (sf *SrvSession) serverHandler(asduPack *asdu.ASDU) error {
	...
	sf.Debug("(server_session.go 422) ASDU %+v", asduPack)
	sf.Debug("RX Raw[% x]", asduPack)
	switch asduPack.Identifier.Type {
	case asdu.C_IC_NA_1: // InterrogationCmd总召
	...
	case asdu.C_RD_NA_1: // ReadCmd102
